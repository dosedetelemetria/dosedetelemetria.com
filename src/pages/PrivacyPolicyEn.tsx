          ...
          <div className="space-y-10">
            <section>
              ...
              <p className="text-white/80">
                Dose de Telemetria is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and protect your personal information when you use our services, including our website and digital products.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 text-white/80 space-y-2">
                ...
                <li><strong>Device information:</strong> Browser type, IP address, operating system, and other technologies on the devices you use to access our site.</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 text-white/80 space-y-2">
                <li><strong>Service providers:</strong> Third parties that help us operate our business and deliver services (payment processors, hosting services, etc.).</li>
                <li><strong>Business partners:</strong> Companies we partner with to offer products or services.</li>
                <li><strong>Legal compliance:</strong> When necessary to comply with a legal obligation, legal process, or governmental request.</li>
              </ul>
            ...
            <section>
              ...
              />
              <p className="text-white/80">
                We implement technical and organizational security measures to protect your personal information against unauthorized access, accidental loss, or destruction. However, no Internet transmission or storage system can guarantee 100% security.
              </p>
            </section>
            ...
            <section>
              ...
              />
              <p className="text-white/80 mb-4">
                According to the General Data Protection Law (LGPD) and other applicable laws, you have the following rights:
              </p>
              <ul className="list-disc pl-5 text-white/80 space-y-2">
              ...
              <p className="text-white/80 mt-4">
                To exercise these rights, please contact us at: contact@dosedetelemetria.com
              </p>
            </section>
            ...
            <section>
              ...
              />
              <p className="text-white/80">
                If you have questions or concerns about this Privacy Policy or our privacy practices, please contact us at: contact@dosedetelemetria.com
              </p>
            </section>
          </div>
        </div>
